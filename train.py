...
#python3 train.py --device=cpu --dataset_path=data/train_sample2.txt --init_model=model/pytorch_kogpt2_676e9bcfa7.params --n_epochs=10
...
from transformers import (AdamW, OpenAIGPTDoubleHeadsModel, OpenAIGPTTokenizer,
                                  GPT2DoubleHeadsModel, GPT2Config, GPT2LMHeadModel, GPT2Tokenizer, WEIGHTS_NAME, CONFIG_NAME)
...
def build_input_from_segments_inference(history, reply, tokenizer, lm_labels=False, with_eos=False):
    bos, eos, sent1, sent2 = tokenizer.convert_tokens_to_ids(SPECIAL_TOKENS[:-1])
